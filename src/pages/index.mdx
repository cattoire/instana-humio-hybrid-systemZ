--- 
title: Think Lab 1201 - Using Instana and Humio to  achieve AI-enhanced enterprise observability—including the mainfram
description: Observability of a hybrid application using Instana and Humio
---

## Introduction

This lab will allow students to learn how to intrument a hybrid application for observability using Instana. We will be albe to integrate log file data
using the Humio integration. The application we look at consist of a cloud native component running in kubernetes (OpenShift) and a traditional server with IBM MQ and IBM App Connect Enterprise. Additionally we will look at some SystemZ components.

We have already instrumented the application for you and through the various lab exercises you will explore the capabillities of the combination of Instana and Humio.

1) In the first portion of the lab, students will look at the Humio integration for a Hybrid application
